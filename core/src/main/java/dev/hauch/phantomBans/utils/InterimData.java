...
/**
 * Interim data for a player's punishments on login.
 */
public class InterimData {
    ...
    public Set<Punishment> getPunishments() { return punishments; }
    public Set<Punishment> getHistory() { return history; }
